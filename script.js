...
function sendMessage() {
    ...
    if (message.trim() !== "") {
        ...
        outputDiv.innerHTML += "<p id='" + messageId + "'>" + day + "." + month + "." + year + " " + time + " - " + message + " <button onclick=\"deleteMessage('" + messageId + "')\">Vymazat</button> <button onclick=\"editMessage('" + messageId + "')\">Upravit</button></p>";
